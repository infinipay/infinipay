...
In order to support loading of multiple wallets in ifp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ifp.cpp.
...
Changes to ifp.cpp
----------------------
ifp.cpp is the entry point into ifp-qt, and as such, will require some minor modifications to provide hooks for
