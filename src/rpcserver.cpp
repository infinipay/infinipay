...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IFP features */
        {"ifp", "masternode", &masternode, true, true, false},
        {"ifp", "masternodelist", &masternodelist, true, true, false},
        {"ifp", "mnbudget", &mnbudget, true, true, false},
        {"ifp", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ifp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ifp", "mnsync", &mnsync, true, true, false},
        {"ifp", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ifpd, or the -server option to ifp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ifp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11426/\n";
}
