                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("INFINIPAY-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IFP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ifp: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IFP Core"), this);
    aboutAction->setStatusTip(tr("Show information about IFP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IFP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IFP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IFP addresses"));
    ...
    openAction->setStatusTip(tr("Open a IFP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IFP Core help message to get a list with possible IFP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IFP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IFP network", "", count));
}
...
{
    QString strTitle = tr("IFP Core"); // default title
