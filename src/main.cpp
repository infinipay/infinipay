...
#if defined(NDEBUG)
#error "IFP cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 0.5 * 60 * 60;
...
const string strMessageMagic = "IFP Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 300) {
		nSubsidy = 1 * COIN;
	} else if (nHeight > 300 && nHeight <= 1000) {
		nSubsidy = 5 * COIN;
	} else if (nHeight > 1000 && nHeight <= 3000) {
		nSubsidy = 20 * COIN;
