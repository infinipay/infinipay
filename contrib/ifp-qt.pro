...
RESOURCES += src/qt/ifp.qrc src/qt/ifp_locale.qrc

TRANSLATIONS += src/qt/locale/ifp_bg.ts \
                src/qt/locale/ifp_de.ts \
                src/qt/locale/ifp_en.ts \
                src/qt/locale/ifp_es.ts \
                src/qt/locale/ifp_fi.ts \
                src/qt/locale/ifp_fr.ts \
                src/qt/locale/ifp_it.ts \
                src/qt/locale/ifp_ja.ts \
                src/qt/locale/ifp_pl.ts \
                src/qt/locale/ifp_pt.ts \
                src/qt/locale/ifp_ru.ts \
                src/qt/locale/ifp_sk.ts \
                src/qt/locale/ifp_sv.ts \
                src/qt/locale/ifp_vi.ts \
                src/qt/locale/ifp_zh_CN.ts \
                src/qt/locale/ifp_zh_TW.ts
